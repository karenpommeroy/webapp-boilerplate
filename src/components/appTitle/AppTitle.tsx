...
const AppTitle = () => {
    ...
    return (
        <Stack direction="row" alignItems="center" className={Styles.appTitle}>
            <Logo onClick={onClick} className={Styles.logo} data-testid="app-logo" />
            <Typography className={classNames(Styles.title, "uppercase")} variant="h6" noWrap data-testid="app-title">
                {t("appName")}
            </Typography>
        </Stack>
    );
