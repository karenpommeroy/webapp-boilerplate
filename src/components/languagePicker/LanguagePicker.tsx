...
export type LanguagePickerTriggerProps = Omit<HTMLAttributes<HTMLButtonElement>, "onClick"> &
    LanguagePickerProps & {
        loading?: boolean;
...
export const LanguagePickerTrigger = (props: LanguagePickerTriggerProps) => {
    ...
    return (
        <Button
            fullWidth={true}
            onClick={onClick}
            className={classNames(Styles.languagePickerTrigger, {
                [Styles.minimal]: mode === ComponentDisplayMode.Minimal,
            })}
            variant="text"
